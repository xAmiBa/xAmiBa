...
|           [Shop Manager App](https://github.com/xAmiBa/Shop_Manager)           | Developed a shop management application utilizing OOP principles, TDD with pytest, and software engineering best practices. Created and managed parent-child classes, model and repository classes, and seamlessly interacted with a PostgreSQL database using the psycopg library. | Python, PostgreSQL, TablePlus |
